...
public class PathPoses : ROSBridgeSubscriber {

	//Path information
	public static Vector3[] pathRosPos;
	public static Quaternion[] pathRosQuat;
	...
	public static void CallBack(ROSBridgeMsg msg) {
		...
		for (var i = 0; i < pathmsg_.getPathLength (); i++) {
			...
			pathRosPos [i] = new Vector3 (px, py, pz);
			pathRosQuat [i] = new Quaternion (qx, qy, qz, qw);
